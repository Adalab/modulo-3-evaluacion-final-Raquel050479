...
const MovieSceneDetail = ({ scene }) => {
  return (
    <article className='cardDetail'>
      ...
      <p className='cardDetail__full-line'><i className="cardDetail__i fa-solid fa-comment"></i>Full line: "{scene.full_line}"</p>
      <p className='cardDetail__director'>
        <i className='cardDetail__i fa-solid fa-clapperboard'></i>Director: {scene.director}
      </p>
      <a className='cardDetail__audio' href={scene.audio} target='_blank'>
        <i className='cardDetail__i fa-solid fa-circle-play'></i>Audio:
      </a>
